...
\cadretechPrisma{Images/prisma.png}{%
  \textbf{Prisma ORM (\textit{Object-Relational Mapping}) v7 :} « est un ORM (\textit{Object-Relational Mapping}) open source de nouvelle génération qui offre
...
\cadretechPostgres{Images/postgres.png}{%
  \textbf{PostgreSQL 16 :} « est un système de gestion de bases de données objet-relationnelles (SGBD-OR — \textit{Système de Gestion de Bases de Données} objet-relationnelles) (\textit{Système de Gestion de Bases de Données}) open source. Il a été pionnier dans de nombreux
