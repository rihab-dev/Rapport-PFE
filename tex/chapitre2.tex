...
sécuritaires (Sprint 1), gestion des clients et contractuelle (Sprint 2), cœur métier opérationnel
...
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  ...
  \item \textbf{Epic 5 -- Gestion des contrats} : US27 à US37 (10 user stories)
...
\textbf{Période :} du 3 avril au 24 avril (\textbf{3 semaines})
\newline
...
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  ...
  \item \textbf{Epic 16 -- Intelligence Artificielle} : US105 à US111 (7 user stories)
\end{itemize}
...
\textbf{Période :} du 25 avril au 22 mai (\textbf{4 semaines})
\newline
\textbf{Objectif du sprint :} Finaliser avec les fonctionnalités avancées de
collaboration, gestion documentaire, notifications multicanaux et planification.

\noindent\textbf{User Stories sélectionnées :}
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  \item \textbf{Epic 10 -- Messagerie} : US70 à US78 (9 user stories)
  \item \textbf{Epic 11 -- Gestion des documents} : US79 à US90 (12 user stories)      
  \item \textbf{Epic 12 -- Notifications} : US91 à US95 (5 user stories)               
  \item \textbf{Epic 13 -- Calendrier et planification} : US66 à US69 (4 user stories)
  \item \textbf{Epic 13 -- Dashboards et rapports} : US96 à US102 (7 user stories)      
\end{itemize}
