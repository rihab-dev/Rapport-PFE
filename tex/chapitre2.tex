...
Le code source doit être structuré de manière modulaire en respectant les standards de conception logicielle (notamment les principes \textbf{SOLID} (acronyme des cinq principes de conception : \textit{Single responsibility} \cite{martin-agile}). Cela assure une maintenance facilitée, une documentation claire des interfaces (API) et une couverture de tests automatisés pour prévenir les régressions lors des évolutions futures.
...
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  ...
  \item \textbf{Epic 2 -- Gestion des utilisateurs} : US06 à US11 (5 user stories)
...
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  ...
  \item \textbf{Epic 14 -- Historique et traçabilité} : US97 à US96 (2 user stories)
\end{itemize}
...
\noindent\textbf{User Stories sélectionnées :}
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  \item \textbf{Epic 8 -- Gestion des demandes clients} : US38 à US44 (7 user stories)
  \item \textbf{Epic 9 -- Gestion des tickets} : US45 à US63 (19 user stories)
  \item \textbf{Epic 15 -- Assistance intelligente} : US98 à US104 (7 user stories)
\end{itemize}
...
\noindent\textbf{User Stories sélectionnées :}
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  \item \textbf{Epic 13 -- Calendrier et planification} : US64 à US67 (4 user stories)
  \item \textbf{Epic 10 -- Messagerie et collaboration} : US68 à US74 (7 user stories)
  \item \textbf{Epic 11 -- Gestion des documents} : US75 à US84 (9 user stories)
  \item \textbf{Epic 12 -- Notifications et alertes} : US85 à US89 (5 user stories)
  \item \textbf{Epic 13 -- Dashboards et rapports} : US90 à US94 (5 user stories)
  \item \textbf{Epic 14 -- Historique et traçabilité} : US12, US82 et US97 (3 user stories)
\end{itemize}
