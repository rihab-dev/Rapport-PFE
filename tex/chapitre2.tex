...
La plateforme doit maintenir des temps de réponse minimaux, même en situation de pics de charge. Cela impose une optimisation de l'accès aux données (mécanismes de mise en cache, requêtage efficient) et une architecture technique capable de supporter une montée en charge progressive (\textit{scalabilité}).
