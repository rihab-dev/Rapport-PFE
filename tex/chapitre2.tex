...
\cadretechSecurite{Images/owasp.png}{%
  \textbf{OWASP :} « L’Open Worldwide Application Security Project (OWASP) est une fondation à but non lucratif qui œuvre pour améliorer la sécurité des logiciels. une communauté ouverte qui a pour mission d'aider les organisations à concevoir, développer, acquérir, exploiter et maintenir des applications fiables » [21]}

  \subsubsection{Outil de test de performance}
\vspace{12pt}
...
\begin{itemize}
  ...
  \item \textbf{OWASP}, Référentiel de sécurité ---
    \url{https://owasp.org/about/} \hfill [21]
  \item \textbf{Grafana k6}, Outil de test de performance ---
