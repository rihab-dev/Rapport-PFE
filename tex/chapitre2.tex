...
Ce chapitre présente l’analyse et la spécification des besoins de la plateforme \textbf{SolidMaint}. 
Nous y identifions les acteurs du système ainsi que leurs besoins fonctionnels et non fonctionnels, avant de procéder à leur modélisation à l’aide d’UML. 
Nous détaillons ensuite l’approche de gestion de projet adoptée, basée sur Scrum, ainsi que la planification des sprints. 
Enfin, nous présentons l’environnement de développement et l’architecture technique de l’application.

\section{Spécification des besoins}
\label{sec:specification_besoins}
L'étape de spécification des besoins est importante pour justifier qu'un besoin réel existe, elle permet de définir explicitement les objectifs à atteindre.
\newline
...
\hline
\endhead % Répète automatiquement cette entête si le tableau passe à la page suivante
...
Dans notre projet, Monsieur Mejdi Dhokar est le Product Owner, Madame Maïssa Ben Fredj et Imen Msakni assurent le rôle de Scrum Masters, 
tandis que nous, Rihab Chourou et Eya Gharbi, constituons l’équipe de développement.
...
Le projet a été mené selon la méthode Scrum, structuré en quatre sprints successifs s'étalant sur une période globale d'environ quatre mois. Cette approche itérative suit une logique architecturale rigoureuse : la mise en place des fondations sécuritaires, le développement de la gestion contractuelle, l'implémentation du cœur métier, et enfin l'intégration des modules collaboratifs et analytiques.
...
\subsubsection{Sprint 2 -- Gestion contractuelle et journal d'activités}
...
\end{itemize}
\newpage
\subsubsection{Sprint 4 -- Communication et Suivi Opérationnel}
...
\begin{itemize}[label=$\blacktriangleright$]
\item \textbf{Logo de SolidMaint :} Conçu via la plateforme \textbf{Canva} en cohérence
avec la charte visuelle de \textbf{SolidWall Consulting}, ce logo associe le
\textbf{noir} et le \textbf{jaune doré} à des symboles évocateurs de la
maintenance, de la sécurité et de la traçabilité des interventions.
\begin{figure}[H]
\centering
...
L'architecture système désigne un ensemble de décisions de conception qui définit
l'interaction des composants entre eux. Le choix de l'architecture est très important
...
L'architecture logicielle retenue est l'\textbf{architecture monolithique
...
Cette architecture a été privilégiée car elle permet de maintenir l'indépendance des modules et
