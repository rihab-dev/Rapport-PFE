...
Le code source doit être structuré de manière modulaire en respectant les standards de conception logicielle (notamment les principes SOLID \refweb{32}). Cela assure une maintenance facilitée, une documentation claire des interfaces (API) et une couverture de tests automatisés pour prévenir les régressions lors des évolutions futures.
...
\subsubsection{Sprint 3 -- Gestion des Demandes, Tickets & Assistance IA}
...
tâches requises et à suivre l'avancement de leur projet. » \refweb{5}
\newline
...
\cadretech{Images/nestjs.png}{%
  ...
  développeurs de coder en JavaScript pur). » \refweb{6}}
...
\cadretech{Images/nextjs.png}{%
  ...
  bas niveau tels que les modules de regroupement et les compilateurs. » \refweb{7}}
...
\cadretech{Images/React-icon.png}{%
  ...
  gèrent leur propre état et se composent pour former des interfaces complexes. » \refweb{8}}
...
\cadretech{Images/chadcn.png}{%
  ...
  modèles d'IA préférés. Logiciel libre. » \refweb{10}}
...
\cadretechVscode{Images/Visual_Studio_Code.png}{%
  ...
  Git et une riche bibliothèque d'extensions. » \refweb{11}}
...
\cadretechDrowio{Images/lucidchart.png}{%
  ...
  faciliter la communication et stimuler l'innovation. » \refweb{14}}
...
\cadretechSwagger{Images/swagger.png}{%
  ...
  partir des annotations du code source. » \refweb{15}}
...
\cadretechPostgres{Images/postgres.png}{%
  ...
  aux standards SQL et ses performances sur de grands volumes de données. » \refweb{17}}
...
\cadretechRedis{Images/redis.jpg}{%
  ...
  avec une durée de vie (TTL) de 60 secondes. » \refweb{18}}
...
\cadretechNeon{Images/Neon.png}{%
  ...
  de démarrer sans infrastructure à gérer. » \refweb{19}}
...
\cadretechDocker{Images/docker.png}{%
  ...
  backend NestJS et le frontend Next.js. » \refweb{20}}
...
\cadretechSecurite{Images/owasp.png}{%
  \textbf{OWASP ZAP :} « L'Open Worldwide Application Security Project (OWASP) est une fondation à but non lucratif qui œuvre pour améliorer la sécurité des logiciels. Dans le cadre de ce projet, l'outil OWASP ZAP a été utilisé pour réaliser des scans automatisés de vulnérabilités sur l'ensemble des endpoints exposés par l'application. » \refweb{21}}
...
\cadretechksix{Images/k6.png}{%
  \textbf{Grafana k6 :} « est un outil de test de performance open source, convivial pour les développeurs et extensible, qui vous aide à détecter rapidement les problèmes de performance et à améliorer proactivement la fiabilité. » \refweb{22}}
...
\cadretechVitest{Images/vitest.png}{%
  \textbf{Vitest :} « est un framework de tests unitaires ultrarapide propulsé par Vite, conçu pour les projets JavaScript et TypeScript modernes. Il permet d'isoler et de valider le comportement de chaque service de manière indépendante grâce à un système de mocks performant. » \refweb{26}}
...
\cadretechPlaywright{Images/playwright.png}{%
  \textbf{Playwright :} « est un framework de tests End-to-End développé par Microsoft, permettant d'automatiser les interactions avec un navigateur réel. Il a été utilisé pour valider les parcours utilisateur complets en simulant les actions réelles sur l'interface graphique de la plateforme. » \refweb{27}}
...
\cadretechLatex{Images/latex.png}{%
  ...
  publication de documents scientifiques. » \refweb{24}}
...
\cadretechCanva{Images/canva.png}{%
  ...
  n'importe quoi et de publier n'importe où. » \refweb{25}}
