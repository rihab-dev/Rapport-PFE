...
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  ...
  \item \textbf{Epic 6 -- Gestion des contrats} : US27 à US36 (10 user stories)
  \item \textbf{Epic 14 -- Historique et traçabilité} : US98 à US99 (2 user stories)
\end{itemize}
...
\noindent\textbf{User Stories sélectionnées :}
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  \item \textbf{Epic 7 -- Gestion des demandes clients} : US37 à US43 (7 user stories)
  \item \textbf{Epic 8 -- Gestion des tickets} : US44 à US64 (21 user stories)
  \item \textbf{Epic 15 -- Assistance intelligente} : US101 à US106 (6 user stories)
\end{itemize}
...
\begin{itemize}[nosep,leftmargin=1.6cm,topsep=0pt,itemsep=2pt,label=$\bullet$]
  ...
  \item \textbf{Epic 10 -- Messagerie et collaboration} : US69 à US76 (8 user stories)
  \item \textbf{Epic 11 -- Gestion des documents} : US77 à US86 (10 user stories)
  \item \textbf{Epic 12 -- Notifications et alertes} : US87 à US91 (5 user stories)
  \item \textbf{Epic 13 -- Dashboards et rapports} : US92 à US97 (6 user stories)
  \item \textbf{Epic 14 -- Historique et traçabilité} : US11, US84 et US100 (3 user stories)
\end{itemize}
