...
\multirow{20}{*}{\centering 8} & \multirow{20}{2.5cm}{\centering Gestion des tickets} 
...
Le client peut consulter et télécharger les documents liés à son contrat. Sur ses tickets, il n'accède qu'aux fichiers qu'il a lui-même soumis. Les documents internes, techniques et les PV sont strictement invisibles pour lui. & ++ \\
\cline{3-6}
& & US84 & En tant qu'\textbf{développeur ou chef de projet}, je souhaite consulter la base de connaissances afin de trouver des solutions existantes. 
...
\cline{3-6}
& & US88 & En tant qu'\textbf{utilisateur}, je souhaite consulter l'historique des consultations d'un document afin de voir qui y a accédé. 
...
\cline{3-6}
& & US91 & En tant qu\textbf{développeur ou chef de projet}, je souhaite recevoir des notifications Slack afin d'être alerté sur mon outil de travail. 
...
\cline{3-6}
& & US96 & En tant que \textbf{client}, je souhaite consulter mon dashboard afin de suivre mes projets. selon notre application
...
& L'utilisateur visualise tous les événements du ticket (créations, changements de statut, sessions, assignations, commentaires, pièces jointes) avec date, heure et auteur. Un filtre par type d'événement est disponible. L'historique est exportable. & +++ \\
\cline{3-6}
& & US104 & En tant qu'\textbf{utilisateur}, je souhaite consulter l'historique de mes activités afin de suivre mes actions dans le système. 
& L'utilisateur visualise toutes ses actions passées avec possibilité de filtrer par date et type d'action. & ++ \\
\hline
...
\cline{3-6}
& & US109 & En tant que \textbf{chef de projet}, je souhaite que l'IA structure automatiquement les solutions saisies en articles KB afin d'améliorer la documentation. 
...
\cline{3-6}
& & US110 & En tant que \textbf{chef de projet}, je souhaite que l'IA fusionne le brouillon d'un blocage avec la solution humaine afin de produire un article KB définitif. 
