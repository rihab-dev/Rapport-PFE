...
\cline{3-6}
& & US85 & En tant que \textbf{client}, je souhaite consulter les documents associés à mes contrats afin d'accéder aux ressources partagées par l'équipe. 
& Le client peut consulter et télécharger les documents liés à ses propres projets. Les documents internes ou techniques (comme les PV) sont bloqués et invisibles pour lui. & ++ \\
\cline{3-6}
