...
\cline{3-6}
& & US92 & En tant qu\textbf{développeur ou chef de projet}, je souhaite recevoir des notifications Slack afin d'être alerté sur mon outil de travail. 
...
\cline{3-6}
& & US97 & En tant que \textbf{client}, je souhaite consulter mon dashboard afin de suivre mes projets. selon notre application
...
\cline{3-6}
& & US106 & En tant que \textbf{chef de projet}, je souhaite que l'IA propose une classification des demandes clients afin d'accélérer leur traitement, avec validation avant transmission au client. 
