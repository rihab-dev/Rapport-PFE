...
Dans le cadre de notre projet de fin d’études (PFE) à l’\textbf{Institut Supérieur des Études Technologiques de Radès} (ISET), nous avons effectué un stage de quatre mois au sein de \textbf{SolidWall Consulting}, du 2 février au 31 mai 2026.
...
Pour mieux comprendre les besoins, nous allons étudier les solutions existantes à deux niveaux : celles déjà en place au sein de \textbf{SolidWall Consulting}, puis celles utilisées dans le monde.
