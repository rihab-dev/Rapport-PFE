...
\end{figure}
            ...
            \newline
Le suivi des interventions repose au quotidien sur des fils de discussion par e-mail, et l’affectation des tickets aux développeurs est effectuée par le responsable, généralement via un message direct. 
...
Après avoir présenté les différentes approches et méthodes de gestion de projet, il convient de justifier les choix retenus dans le cadre de ce travail.
...
Pour SolidMaint, ce rôle est incarné par le binôme d'étudiantes Rihab Chourou et Eya Gharbi, qui assure conjointement l'ensemble des travaux techniques du projet.
