...
Forte d'une équipe dynamique et diversifiée et de profils reconnus, l’entreprise a pour objectif constant d'apporter une forte valeur ajoutée et de proposer des solutions modernes permettant aux entreprises de se démarquer sur leurs marchés respectifs. » \refweb{1} « Fondée avec la vision d'accompagner les organisations publiques et privées vers l'excellence technologique et opérationnelle, Solid Wall Consulting s'est rapidement imposée comme un partenaire de confiance à l'international. » \refweb{2}.
...
Lancée en 2003 et maintenue par l'éditeur français Teclib, GLPI est une solution open-source leader en gestion des services informatiques (ITSM) et d'infrastructures. \textbf{Fonctionnalités clés} : gestion de parc (inventaire, licences, cycle de vie des actifs), centre de services avec gestion d'incidents et demandes, suivi des SLA et base de connaissances, conformité ITIL. \textbf{Tarification} : version communautaire gratuite (on-premise) sous licence GPLv3+, avec abonnements payants optionnels pour support Cloud managé ou assistance professionnelle. \refweb{28}
...
Créée en 2011 par Freshworks, Freshdesk est une plateforme SaaS leader en gestion de support client omnicanale. \textbf{Fonctionnalités clés} : centralisation des demandes (email, chat, téléphone, réseaux sociaux), distribution intelligente des tickets, automatisation, base de connaissances et IA (Freddy AI). \textbf{Tarification} : modèle freemium (gratuit limité à 10 agents) suivi de plans payants mensuels ou annuels (Growth, Pro, Enterprise) au prix de 15€/agent/mois. \refweb{29}
...
Fondée en 2002, Atlassian a développé Jira Service Management, solution IT dédiée à la gestion des incidents, demandes de service et changements. \textbf{Fonctionnalités clés} : workflows configurables, catalogue de services, suivi des SLA, automatisations et intégrations étroites avec l'écosystème Atlassian. \textbf{Tarification} : modèle SaaS par agent (20€/mois) ou éditions self-managed (Data Center) pour les organisations à grande échelle. \refweb{30}
...
\begin{table}[H]
    ...
    \hline
    \rowcolor{blue!20}
    \textbf{Critères de comparaison} & \textbf{GLPI \refweb{28}} & \textbf{Jira SM \refweb{30}} & \textbf{Freshdesk \refweb{29}} \\
    \hline
    ...
    \hline
    Messagerie \& Chat intégré & $\times$ & Limité & \checkmark \\
    \hline
...
\item \textbf{Accepter le changement plutôt que suivre un plan immuable} : nous voyons le changement comme une opportunité d'adaptation. Le projet doit pouvoir évoluer sans sacrifier la cohérence globale ni la qualité des livraisons. \refweb{3}
\end{itemize}
...
« Le langage de modélisation unifié (UML) est un langage permettant de spécifier, visualiser, construire et documenter les artefacts des systèmes logiciels, ainsi que de modéliser des systèmes métier et d'autres systèmes non logiciels. L'UML représente un ensemble de bonnes pratiques d'ingénierie qui ont fait leurs preuves dans la modélisation de systèmes vastes et complexes. » \refweb{4}
