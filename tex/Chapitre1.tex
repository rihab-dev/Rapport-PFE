...
Lancée en 2003 et maintenue par l'éditeur français Teclib, GLPI est une solution open-source leader en gestion des services informatiques (ITSM) et d'infrastructures. \textbf{Fonctionnalités clés} : gestion de parc (inventaire, licences, cycle de vie des actifs), centre de services avec gestion d'incidents et demandes, suivi des SLA et base de connaissances, conformité ITIL. \textbf{Tarification} : version communautaire gratuite (on-premise) sous licence GPLv3+, avec abonnements payants optionnels pour support Cloud managé ou assistance professionnelle. [28]
...
\begin{table}[H]
    ...
    \small
    \begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{4cm}|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\backslash}X|}
    \hline
    \rowcolor{blue!20}
    \textbf{Critères de comparaison} & \textbf{GLPI [28]} & \textbf{Jira SM [30]} & \textbf{Freshdesk [29]} \\
    \hline
