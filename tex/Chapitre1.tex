...
\end{table}
\noindent \textbf{Note sur les coûts —} Les tarifs annuels affichés pour 10 utilisateurs sont calculés selon la formule suivante : $\text{Prix mensuel par utilisateur} \times 10\text{ utilisateurs} \times 12\text{ mois}$. Dans cette évaluation, GLPI représente uniquement le coût du support entreprise annuel, sa version communautaire étant gratuite. Pour Freshdesk, le calcul s'établit à $15\text{€/mois} \times 10 \times 12 = 1800\text{€/an}$, tandis que pour Jira Service Management (Jira SM), il s'élève à $20\text{€/mois} \times 10 \times 12 = 2400\text{€/an}$. Il est à noter que ces montants correspondent aux offres de base et sont susceptibles d'augmenter avec l'ajout de fonctionnalités optionnelles, de supports premium ou de services de personnalisation.
