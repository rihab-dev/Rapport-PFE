...
L' approche agile de \textbf{SolidWall Consulting} garantit une gestion optimisée et par conséquent, d'un résultat de qualité.»\cite{site-solidwall}
...
\item \textbf{Accepter le changement plutôt que suivre un plan immuable} : nous voyons le changement comme une opportunité d'adaptation. Le projet doit pouvoir évoluer sans sacrifier la cohérence globale ni la qualité des livraisons. \cite{agile-manifesto}
\end{itemize}
