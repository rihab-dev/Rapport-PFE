...
C’est dans ce contexte que s’inscrit notre projet de fin d’études, visant à concevoir et réaliser \textbf{SolidMaint}, une plateforme web \textbf{inter-entreprises (B2B)} qui permet à SolidWall Consulting de gérer les relations contractuelles directement avec ses entreprises clientes. L’objectif principal consiste à automatiser et centraliser l’ensemble du processus métier, depuis la soumission des demandes clients jusqu’à la résolution des incidents, tout en garantissant une traçabilité complète et le respect des engagements contractuels.
\newline
