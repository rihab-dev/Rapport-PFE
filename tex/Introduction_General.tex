...
Le \textbf{premier chapitre} établit le cadre général avec la présentation de l'organisme d'accueil, l'analyse de l'existant, l'étude comparative des solutions du marché, la définition de la solution proposée et le choix de la méthodologie Scrum.
...
Le \textbf{troisième chapitre} présente la réalisation du premier sprint, consacré à l'authentification sécurisée, à la gestion des utilisateurs, au système de rôles et permissions (RBAC) et aux demandes d'inscription OAuth.

Le \textbf{quatrième chapitre} couvre le deuxième sprint, dédié à la gestion des clients, des projets et des contrats de maintenance, incluant le système d'alertes SLA et la traçabilité des activités.

Le \textbf{cinquième chapitre} présente le troisième sprint, centré sur le cœur métier de la plateforme : gestion des demandes, gestion des tickets, suivi du temps, respect des SLA et intégration de l'intelligence artificielle.

Le \textbf{sixième chapitre} décrit le quatrième et dernier sprint, regroupant les fonctionnalités avancées de collaboration, de messagerie temps réel, de gestion documentaire, de notifications multicanaux, de génération de rapports et de tableaux de bord analytiques. Il présente également la stratégie de tests et les validations conduites sur l'ensemble de la plateforme.
