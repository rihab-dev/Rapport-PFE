...
\begin{enumerate}[label=\textbf{\arabic*}, leftmargin=2.5cm, itemsep=0.5cm]
    \item \hyperref[sec:backlog_sprint1]{\textbf{Backlog du Sprint 1}} \dotfill \textbf{\pageref{sec:backlog_sprint1}}
    
    \item \hyperref[sec:analyse_sprint1]{\textbf{Analyse}} \dotfill \textbf{\pageref{sec:analyse_sprint1}}
    
    \item \hyperref[sec:conception_sprint1]{\textbf{Conception}} \dotfill \textbf{\pageref{sec:conception_sprint1}}
    
    \item \hyperref[sec:realisation_sprint1]{\textbf{Réalisation}} \dotfill \textbf{\pageref{sec:realisation_sprint1}}
    
    \item \hyperref[sec:tests_sprint1]{\textbf{Tests}} \dotfill \textbf{\pageref{sec:tests_sprint1}}
\end{enumerate}
