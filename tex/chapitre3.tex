...
\newline \begin{center} \textit{Endpoint : \textbf{POST /api/auth/login}} \end{center}
...
\newline \begin{center} \textit{Endpoint : \textbf{PUT /api/profil}} \end{center}
...
\item[$\square$] \textbf{ Test Authentification}
\newline \begin{center} \textit{10 scénarios : connexion classique, OAuth, déconnexion} \end{center}
...
\newline \begin{center} \textit{1 scénario : désactivation avec réassignation des tickets} \end{center}
