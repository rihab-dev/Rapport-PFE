...
\begin{itemize}[label=$\bullet$] 
    \item Vérification des tickets et demandes en cours avant la désactivation. 
    \item Vérification de la réassignation des tickets.
     \item Désactivation d'un utilisateur actif via le menu d'actions avec confirmation.
      \item Vérification que l'utilisateur désactivé ne peut plus se connecter.
       \item Réactivation d'un utilisateur désactivé via le menu d'actions avec confirmation. 
       \item Vérification que l'utilisateur réactivé peut se reconnecter.
     \end{itemize}
\begin{figure}[H]
        \centering
