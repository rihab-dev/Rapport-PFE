...
\item Le système crée la demande d'inscription avec le statut \textit{en attente}.
...
% \subsubsection{Description textuelle du cas d’utilisation «Consulter liste utilisateurs »}
% 
% \footnotesize
% \renewcommand{\arraystretch}{0.95}
% \begin{longtable}{|P{3.5cm}|P{10.5cm}|}
...
% \hline
% \textbf{Postcondition} & Liste des utilisateurs affichée \\
% \hline
% \textbf{Scénario nominal} &
...
% % \end{minipage} \\
% \hline
% \textbf{Scénario alternatif} & L'administrateur clique sur le bouton « Exporter ». \\
% \hline
% \end{longtable}
% \normalsize
% \vspace{-0.3cm}
...
\hline
\textbf{Postcondition} & Le compte utilisateur est créé et activé, la demande est marquée \textit{approuvée}, et l'utilisateur est notifié \\
\hline
\textbf{Scénario principal} &
\begin{minipage}[t]{\linewidth}\raggedright
\begin{enumerate}[label=\arabic*., leftmargin=0.6cm, nosep, itemsep=1pt]
...
% \subsubsection{Description textuelle du cas d’utilisation «Consulter liste permissions »}
% 
% \footnotesize
% \renewcommand{\arraystretch}{0.95}
% \begin{longtable}{|P{3.5cm}|P{10.5cm}|}
...
% \textbf{Acteurs} & Administrateur \\
% \hline
% \textbf{Précondition} & L'administrateur est authentifié et dispose de la permission d'accès au module des rôles. \\
% \hline
% \textbf{Postcondition} & L'interface affiche la liste complète des permissions et leurs assignements. \\
% \hline
% \textbf{Scénario nominal} &
% \begin{minipage}[t]{\linewidth}\raggedright
% \begin{enumerate}[label=\arabic*., leftmargin=0.6cm, nosep, itemsep=1pt]
% \item L'administrateur clique sur l'onglet « Permissions ».
% \item Le système interroge la base de données pour récupérer la liste des rôles et permissions.
% \item Le système affiche une vue matricielle.
% \item L'administrateur consulte quelles permissions sont actives par rôle.
% \item L'administrateur utilise les filtres natifs pour n'afficher qu'une partie de la matrice.
% \end{enumerate}
% \end{minipage} \\
% \hline
% \textbf{Scénario alternatif} &
% \begin{enumerate}[label=A\arabic*.,nosep,leftmargin=0.6cm,topsep=0pt,itemsep=1pt]
% \item  L'administrateur choisit de basculer la présentation. Le système réorganise instantanément les données pour afficher une liste empilée des rôles contenant chacun leurs listes de permissions respectives. Le but initial (consulter) est atteint avec succès sous une autre forme.
% \end{enumerate} \\
% \hline
% \end{longtable}
% \captionof{table}{Description textuelle « Consulter liste permissions »} 
% \normalsize
% \vspace{-0.3cm}
...
% ── 1. Authentification ───────────────────────────────────────────────────────
\item[$\square$] \textbf{Test Module Authentification}
\newline
...
\end{figure}
% ── 2. RBAC ───────────────────────────────────────────────────────────────────
\item[$\square$] \textbf{Test Module Gestion des rôles et permissions (RBAC)}
\newline
...
\item[$\square$] \textbf{ Test Authentification}
...
\item[$\square$]  \textbf { Test Gestion du profil}
...
\item[$\square$] \textbf{Test Gestion des utilisateurs} ---
