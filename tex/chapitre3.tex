...
Nous avons réalisé des tests API, dont la documentation Swagger facilite l'exécution en offrant une interface permettant de tester directement les endpoints.

\begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth,keepaspectratio]{Images/gestion profil Swagger.png}
        \caption{Test de l'endpoint de récupération du profil utilisateur via Swagger}
    \end{figure}

\subsubsection{Tests End-to-End} 
Nous avons testé les parcours critiques à l'aide de Playwright, garantissant ainsi que l'ensemble du système fonctionne correctement du point de vue de l'utilisateur.\begin{figure}[H]
        \centering
