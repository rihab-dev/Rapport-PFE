...
\begin{figure}[H]
        ...
        \label{Diagramme de séquence du cas d’utilisation « Mot de passe oublié »}
\end{figure}
...
\begin{figure}[H]
        ...
        \label{Diagramme de séquence du cas d’utilisation « Désactiver utilisateur »}
\end{figure}
...
\begin{itemize}
  \item[$\square$]  \textbf{Test de changer mot de passe}
  
 \noindent Par ces tests, nous visons à valider le bon fonctionnement des méthodes \textbf{demanderReinitialisationMotDePasse()} et \textbf{reinitialiserMotDePasse()}, qui gèrent le processus de réinitialisation du mot de passe utilisateur.
