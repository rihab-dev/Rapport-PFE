...
\hline
\textbf{Postconditions} & La demande d'inscription est créée (« en attente »), ou le visiteur est connecté s'il possède déjà un accès. \\
\hline
\textbf{Scénario nominal} &
\begin{minipage}[t]{\linewidth}\raggedright
...
\item  Lors du changement de mot de passe, le mot de passe actuel fourni est faux. L'utilisateur rectifie le mot de passe pour réussir.\end{itemize} \\
\hline
\textbf{Scénarios d'exception} &
\begin{itemize}[nosep,leftmargin=0.6cm,topsep=0pt,itemsep=1pt, label=$\bullet$]
...
\hline
\textbf{Postconditions} & Le compte utilisateur est créé et activé, la demande est marquée \textit{approuvée}, et l'utilisateur est notifié \\
\hline
\textbf{Scénario principal} &
\begin{minipage}[t]{\linewidth}\raggedright
\begin{enumerate}[label=\arabic*., leftmargin=0.6cm, nosep, itemsep=1pt]
