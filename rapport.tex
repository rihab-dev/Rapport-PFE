...
% --- Hiérarchie visuelle progressive (cascade) ---
% Chapitre : texte à -5pt (flush gauche)
\setlength{\cftchapindent}{-5pt}
\setlength{\cftchapnumwidth}{72pt}

% Section   : numéro à 20pt, texte à 50pt
\setlength{\cftsecindent}{20pt}
\setlength{\cftsecnumwidth}{30pt}

% Subsection : numéro à 50pt (= texte section), texte à 78pt
\setlength{\cftsubsecindent}{50pt}
\setlength{\cftsubsecnumwidth}{28pt}

% Subsubsection : numéro à 78pt (= texte subsec), texte à 118pt
\setlength{\cftsubsubsecindent}{78pt}
...
% ---- Chapitre 4 ----
\chaptercover{4}{Sprint 2 -- Gestion contractuelle Et journal d'activités}{Sprint 2 \\ Gestion contractuelle Et journal d'activités}
\input{tex/chapitre4}
\cleardoublepage
