...
\setlength{\cftchapindent}{-5pt}   % légèrement à gauche de la marge
\setlength{\cftchapnumwidth}{72pt} % largeur pour le préfixe «Chapitre N»
...
% Correctif hyperref+minitoc : chaque \section pose une ancre précise
% via \phantomsection avant l'incrémentation du compteur
\makeatletter
...
% ============================================================
% \hiddenpart prépare le compteur minitoc AVANT la page de couverture
% afin que \minitoc lise le bon fichier .mtcN
\makeatletter
...
\newcommand{\chaptercover}[3]{%
  ...
  \addcontentsline{toc}{chapter}{Chapitre #1\hspace{0.7em}#2}%
  \chaptermark{#2}%
  \thispagestyle{empty}%
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=center,
      ...
      {\hyphenpenalty=10000\exhyphenpenalty=10000 #3};
...
% ---- Chapitre 1 ----
\chaptercover{1}{Cadre général du projet}{Cadre général du projet}
\input{tex/Chapitre1}
\cleardoublepage

% ---- Chapitre 2 ----
\chaptercover{2}{Préparation du projet}{Préparation du projet}
\input{tex/chapitre2}
\cleardoublepage

% ---- Chapitre 3 ----
\chaptercover{3}{Sprint 1 -- Socle Sécurité et Contrôle d'Accès}{Sprint 1 \\ Socle Sécurité et Contrôle d'Accès}
\input{tex/chapitre3}
\cleardoublepage

% ---- Chapitre 4 ----
\chaptercover{4}{Sprint 2 -- Gestion Contractuelle et Traçabilité}{Sprint 2 \\ Gestion Contractuelle et Traçabilité}
\input{tex/chapitre4}
\cleardoublepage

% ---- Chapitre 5 ----
\chaptercover{5}{Sprint 3 -- Gestion Opérationnelle et Assistance IA}{Sprint 3 \\ Gestion Opérationnelle et Assistance IA}
\input{tex/chapitre5}
\cleardoublepage

% ---- Chapitre 6 ----
\chaptercover{6}{Sprint 4 -- Communication et Suivi Opérationnel}{Sprint 4 \\ Communication et Suivi Opérationnel
}
\input{tex/chapitre6}
\cleardoublepage
