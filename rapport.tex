...
\newcommand{\chaptercover}[2]{%
  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    % --- Numéro en filigrane, centré sur la page ---
    \node[anchor=center,
          font=\fontsize{200}{200}\selectfont\bfseries\rmfamily,
    ...
    \node[anchor=center, inner sep=0pt]
      at ([yshift=0.26\paperheight] current page.center) {%
        \begin{tikzpicture}
    ...
    \node[anchor=center,
      ...
      at ([yshift=0.215\paperheight] current page.center)
    ...
    \node[anchor=center, inner sep=0pt]
      at ([yshift=0.09\paperheight] current page.center) {%
        \begin{tikzpicture}
    ...
    \node[anchor=center,
      ...
      at ([yshift=0.065\paperheight] current page.center)
      {Sommaire};
...
% ---- Chapitre 2 ----
\hiddenpart{Analyse et spécifications des besoins}
\chaptercover{2}{Analyse et spécifications des besoins}
\input{tex/chapitre2}

% ---- Chapitre 3 ----
\hiddenpart{Conception}
\chaptercover{3}{Conception}
\input{tex/chapitre3}
